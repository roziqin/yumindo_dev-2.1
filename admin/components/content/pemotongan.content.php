...
?>
    ...
    $(document).ready(function() {
        ...
        $('#table-pemotongan').DataTable( {
            ...
            "ajax": 
            {
                "url": "api/datatable.api.php?ket=pemotongan", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "columns": [
                ...
                $('.btn-edit').on('click',function(){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            $("#modalpemotongan .btn-proses").text("Selesai Potong & Jahit");

                            if (data[0].status=='Selesai Jahit') {
