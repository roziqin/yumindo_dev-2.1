...
?>
    <table id="table-penagihan" class="table table-striped table-bordered fadeInLeft slow animated" style="width:100%">
        <thead>
            <tr>
                <th>Tanggal</th>
    ...
    $(document).ready(function() {
        ...
        $('#table-penagihan').DataTable( {
            ...
            "ajax": 
            {
                "url": "api/datatable.api.php?ket=penagihan", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "columns": [
                ...
                { "render": function(data, type, full){
                   return formatRupiah(full['pengukuran_tagihan'].toString(), 'Rp. ');
                  }
                },
                ...
                $('.btn-edit').on('click',function(){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            var totalharga = parseInt(data[0].harga)+parseInt(data[0].diskon);
                            ...
                            $("#modalpenagihan .dp").text(formatRupiah(data[0].dp.toString(), 'Rp. '));
                            $("#modalpenagihan .sisa").text(formatRupiah(data[0].sisa.toString(), 'Rp. '));
                            $("#modalpenagihan #defaultForm-idpengukuran").val(data[0].id);
                            $("#modalpenagihan .box-tagihan").removeClass("hidden");
                            $("#modalpenagihan .box-lunas").addClass("hidden");
